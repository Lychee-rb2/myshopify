...
export type ProductsQuery = { __typename?: 'QueryRoot', products: { __typename?: 'ProductConnection', nodes: Array<{ __typename?: 'Product', id: string }> } };
 ...
 * @example
 * mockProductsQuery((req, res, ctx) => {
 *   return res(
 *     ctx.data({ products })
 *   )
 * })
 */
export const mockProductsQuery = (resolver: ResponseResolver<GraphQLRequest<ProductsQueryVariables>, GraphQLContext<ProductsQuery>, any>) =>
